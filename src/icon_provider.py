...
# Settings tabs
def tab_appearance(c="#b0b0b0"):  return get("mdi.palette-outline",        c)
def tab_files(c="#b0b0b0"):       return get("mdi.folder-multiple-outline",c)
def tab_panels(c="#b0b0b0"):      return get("mdi.view-dashboard-outline", c)
def tab_search(c="#b0b0b0"):      return get("mdi.magnify",                c)
def tab_behavior(c="#b0b0b0"):    return get("mdi.tune-variant",           c)
def tab_tools(c="#b0b0b0"):       return get("mdi.hammer-screwdriver",     c)
def tab_system(c="#b0b0b0"):      return get("mdi.desktop-tower-monitor",  c)

# File type badges (used where a plain glyph, not a full file icon, is needed)
def type_image(c="#b0b0b0"):      return get("mdi.image-outline",          c)
def type_video(c="#b0b0b0"):      return get("mdi.movie-outline",          c)
def type_audio(c="#b0b0b0"):      return get("mdi.music-note-outline",     c)
def type_docs(c="#b0b0b0"):       return get("mdi.file-document-outline",  c)
def type_code(c="#b0b0b0"):       return get("mdi.code-tags",              c)
def type_archive(c="#b0b0b0"):    return get("mdi.zip-box-outline",        c)
def type_all(c="#b0b0b0"):        return get("mdi.asterisk",               c)
def warning_icon(c="#dcdcaa"):    return get("mdi.alert-outline",          c)
def rocket_icon(c="#b0b0b0"):     return get("mdi.rocket-launch-outline",  c)
def bolt_icon(c="#b0b0b0"):       return get("mdi.lightning-bolt-outline", c)
def dual_panel_icon(c="#b0b0b0"): return get("mdi.view-week-outline",      c)
def eye_icon(c="#b0b0b0"):        return get("mdi.eye-outline",            c)
def add_text_icon(c="#b0b0b0"):   return get("mdi.form-textbox",           c)
def numbering_icon(c="#b0b0b0"):  return get("mdi.numeric",                c)
def case_icon(c="#b0b0b0"):       return get("mdi.format-letter-case",     c)
def move_icon(c="#b0b0b0"):       return get("mdi.folder-move-outline",    c)
def close_icon(c="#b0b0b0"):      return get("mdi.close",                  c)
def pause_icon(c="#b0b0b0"):      return get("mdi.pause",                  c)
def play_icon(c="#b0b0b0"):       return get("mdi.play",                   c)
def check_icon(c="#4ec9b0"):      return get("mdi.check-circle-outline",   c)
def error_icon(c="#f44747"):      return get("mdi.alert-circle-outline",   c)
def transfer_tray_icon(c="#b0b0b0"): return get("mdi.tray-arrow-down",     c)
def clear_icon(c="#b0b0b0"):      return get("mdi.broom",                  c)
